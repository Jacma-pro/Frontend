...
- **Framework** : Ensemble d'outils et de bibliothèques facilitant le développement d'applications web.
...
- **Composants** : Blocs de construction réutilisables pour créer des interfaces utilisateur.
